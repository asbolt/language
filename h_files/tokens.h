...
const Function functionsWithNoArg [] =  {{"(",                FUNCTION_WITH_NO_ARG,  2,  1},
...
const Function functionsWithOneArg [] = {{"vernut",           FUNCTION_WITH_ONE_ARG, 1,  6},
                                         ...
                                         {"celoeP",           FUNCTION_WITH_ONE_ARG, -1,  6}};

const Function functionsWithTwoArg [] = {{";",                FUNCTION_WITH_TWO_ARG, 0,  1},
                                         {"+",                FUNCTION_WITH_TWO_ARG, 1,  1},
                                         {"-",                FUNCTION_WITH_TWO_ARG, 2,  1},
                                         {"*",                FUNCTION_WITH_TWO_ARG, 3,  1},
                                         {"/",                FUNCTION_WITH_TWO_ARG, 4,  1},
                                         {"=",                FUNCTION_WITH_TWO_ARG, 5,  1},
                                         {"celoeF",           FUNCTION_WITH_TWO_ARG, -1,  6},
                                         {"poka",             FUNCTION_WITH_TWO_ARG, 7,  4},
                                         {"esli",             FUNCTION_WITH_TWO_ARG, 8,  4},
                                         {"<",                FUNCTION_WITH_TWO_ARG, 9,  1},
                                         {">",                FUNCTION_WITH_TWO_ARG, 10, 1}};
